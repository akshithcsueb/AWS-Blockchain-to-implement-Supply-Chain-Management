// Retrieves a list of products from the API. This component also receives updates when other users change the state of the data using GraphQL subscriptions.
